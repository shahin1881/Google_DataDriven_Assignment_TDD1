...
public class testUtil extends CoreTest{
	...
	public static ExcelReader excel =new ExcelReader(System.getProperty("user.dir")+"\\src\\test\\java\\google_dd_properties\\testData.xlsx");
...
public static Object[][] getData(String sheetName){
	//String sheetName="googleLoginTest_01";
...
public static void captureScreenshot(String methodName) throws IOException{
		...
		mailscreenshotpath = System.getProperty("user.dir")+"\\screenshot\\"+methodName+"_"+year+"_"+date+"_"+(month+1)+"_"+day+"_"+min+"_" +sec+".jpeg";//.docx
